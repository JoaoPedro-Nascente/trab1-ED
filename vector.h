...
// Retorna o maior elemento do vector (assumindo que podemos comparar elementos usando uma função de comparação)
data_type vector_max(Vector *v, int (*compare)(const void *, const void *));

// Retorna o menor elemento do vector (assumindo que podemos comparar elementos usando uma função de comparação)
data_type vector_min(Vector *v, int (*compare)(const void *, const void *));

// Retorna o índice do maior elemento do vector (assumindo que podemos comparar elementos usando uma função de comparação)
int vector_argmax(Vector *v, int (*compare)(const void *, const void *));

// Retorna o índice do menor elemento do vector (assumindo que podemos comparar elementos usando uma função de comparação)
int vector_argmin(Vector *v, int (*compare)(const void *, const void *));
...
// Insere o elemento na i-ésima posição.
...
// Retorna o índice de val usando busca binária. Retorna -1 se não encontrado.
